// GFBITS=13 variant for mceliece6688128
use crate::common::*;
use crate::decode;
...
pub(crate) const SYS_N: usize = 6688;
pub(crate) const PK_NROWS: usize = 1664;
pub(crate) const PK_NCOLS: usize = 5024;
pub(crate) const PK_ROW_BYTES: usize = 628;
...
pub(crate) const CRYPTO_PUBLICKEYBYTES: usize = 1044992;
pub(crate) const CRYPTO_SECRETKEYBYTES: usize = 13932;
pub(crate) const CRYPTO_CIPHERTEXTBYTES: usize = 208;
pub(crate) const CRYPTO_BYTES: usize = 32;

/// Post-process step for the forward FFT (GFBITS=13, 6688128 variant).
...
/// Forward Gao-Mateer FFT (128-point, GFBITS=13, 6688128 variant).
