...
macro_rules! transcript_kat {
    ($test_name:ident, $variant:ident, $p:ty, $expected_hash:literal) => {
        #[test]
        fn $test_name() {
            use backbone_sntrup::params::Params;
            use backbone_sntrup::$variant::*;
