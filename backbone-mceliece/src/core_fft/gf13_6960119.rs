// GFBITS=13 variant for mceliece6960119
use crate::common::*;
use crate::decode;
...
pub(crate) const SYS_T: usize = 119;
pub(crate) const SYS_N: usize = 6960;
pub(crate) const PK_NROWS: usize = 1547;
pub(crate) const PK_NCOLS: usize = 5413;
pub(crate) const PK_ROW_BYTES: usize = 677;
pub(crate) const SYND_BYTES: usize = 194;
pub(crate) const IRR_BYTES: usize = 238;
pub(crate) const COND_BYTES: usize = 12800;
pub(crate) const GFMASK: u16 = 8191u16;
pub(crate) const CRYPTO_PUBLICKEYBYTES: usize = 1047319;
