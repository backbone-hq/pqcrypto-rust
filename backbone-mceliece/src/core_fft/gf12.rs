...
//! GF(2^12) core (McEliece 348864).
//!
//! Structurally distinct from the GF(2^13) cores: 12-bit bit-sliced ops
//! (`vec_ops::gf12`), a 63-element FFT, and a windowed `gf_mul_poly`. It is
//! the single 12-bit parameter set, so it is not duplicated and stays a
//! plain module.
